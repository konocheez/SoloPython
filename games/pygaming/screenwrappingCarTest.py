...
while True:
    ...
    FPS.tick(24)
        ...
        # # still trying to loop the display
        # position = ship.image.get_rect(center = (ship.x, ship.y))
        # wrap_around = False
        #
        # if position[0] <  0 :
        #     # off screen left
        ...
        #     wrap_around = True
        #
        # if position[0]  + ship.image.get_width() > WIDTH:
        #     # off screen right
        #     position.move_ip(-WIDTH, 0)
        #     wrap_around = True
        #
        ...
        #     wrap_around = True
        #
        # if position[1] + ship.image.get_height() > HEIGHT:
        #     # off screen bottom
        #     position.move_ip(0, -HEIGHT)
        #     wrap_around = True
        #
